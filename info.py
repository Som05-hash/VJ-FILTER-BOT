...
API_ID = int(environ.get('API_ID', '26482938'))
API_HASH = environ.get('API_HASH', 'ccbf3d2e4e4a420f865a0a00344f88f0')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6111080528').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002619878695'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002628056220').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sahebchoudhury067:CElXPsYmo4XnJDQO@cluster0.crhcvk3.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+s4BZZ2XNx7c3Njll')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Graduate_Movies')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Graduate_Request') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/scrxsom')
